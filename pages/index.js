  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:image" content={`${process.env.NEXT_PUBLIC_BASE_URL}/cardwar.png`} />
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:image" content={`${process.env.NEXT_PUBLIC_BASE_URL}/cardwar.png`} />
